...
# from flask_gravatar import Gravatar ##critical update in Flask and it's not supporting Gravatar anymore
...
class BlogPost(db.Model):
    ...
    author = relationship("User", back_populates="posts")  #Mapped[str] = mapped_column(String(250), nullable=False)
